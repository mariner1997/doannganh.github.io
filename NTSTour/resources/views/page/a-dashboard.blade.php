...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('addtour')}}">
                    <i class="fas fa-plus"></i>
                    <span>Thêm tour mới</span>
                </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="site-section">
                            ...
                            <div class="container">
                                <h4 class="font-weight-light">Tour trong nước</h4>
                                <hr>
                                <div class="row">
                                    @foreach($new_product as $new)
                                    <div class="col col-lg-4 mb-4 mb-lg-4">
                                        ...
                                        <div class="col offset-1">
                                            <a href="{{route('edittour',$new->id)}}" class="btn btn-primary py-2 px-4 mt-2 col-5"> Sửa</a>
                            ...
                            <div class="site-section">
                                ...
                                <div class="container">
                                    <h4 class="font-weight-light">Tour nước ngoài</h4>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col col-lg-4 mb-4 mb-lg-4">
                                            ...
                                            <div class="col offset-1">
                                                <a href="{{route('edittour',$spkm->id)}}" class="btn btn-primary py-2 px-4 mt-2 col-5"> Sửa</a>
